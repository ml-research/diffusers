...
class SemanticStableDiffusion3Pipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    r"""
    Args:
    ...
    def encode_prompt(
        ...
        return prompt_embeds, negative_prompt_embeds, pooled_prompt_embeds, negative_pooled_prompt_embeds, editing_prompt_embeds, editing_pooled_prompt_embeds
    ...
    def __call__(
        ...
        if self.do_classifier_free_guidance:
            if enable_edit_guidance:
                ...
                pooled_prompt_embeds = torch.cat([negative_pooled_prompt_embeds, pooled_prompt_embeds, pooled_edit_embeds], dim=0)
            else:
        ...
        return SemanticStableDiffusionPipelineOutput(images=image, nsfw_content_detected=None)
