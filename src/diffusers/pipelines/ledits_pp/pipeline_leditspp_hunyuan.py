...
class LEditsPPPipelineHunyuan(DiffusionPipeline):
    #todo
    r"""
   Pipeline for textual image editing using LEDits++ with HunyuanDiT.
    ...
    def encode_prompt(
        ...
        num_edit_tokens = 0  # TODO: Implement this
        return negative_prompt_embeds, negative_prompt_attention_mask, num_edit_tokens
    ...
    def __call__(
        ...
        **kwargs,
        ...
        add_time_ids = torch.tensor([add_time_ids], dtype=negative_prompt_embeds.dtype)
