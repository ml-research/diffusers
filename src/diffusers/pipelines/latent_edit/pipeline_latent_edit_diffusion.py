...
class LatentEditDiffusionPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        return LatentEditDiffusionPipelineOutput(images=image, inappropriate_content_detected=has_nsfw_concept)
