...
class SemanticHunyuanDiTPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
...
@slow
@require_torch_gpu
class SemanticHunyuanDiTPipelineIntegrationTests(unittest.TestCase):
    prompt = "一个宇航员在骑马"
    ...
    def test_hunyuan_dit_1024(self):
        ...
        pipe = SemanticHunyuanDiTPipeline.from_pretrained(
