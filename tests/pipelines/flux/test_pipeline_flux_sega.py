...
from diffusers import FluxSemanticGuidancePipeline as FluxPipeline
...
class FluxPipelineFastTests(unittest.TestCase, PipelineTesterMixin):
    ...
    def test_flux_prompt_embeds(self):
        ...
        (prompt_embeds, pooled_prompt_embeds, text_ids, editing_prompt_embeds,
         pooled_editing_prompt) = pipe.encode_prompt(
            prompt,
            prompt_2=None,
            device=torch_device,
